...
output_file = r'C:\Users\thomas.scattergood\AutomationPython\More_Exercises\swing_trading_email_to_csv_exercise\output2.csv'
all_trades_raw = """
PEP Short $153.68
Stop Loss $156.98
Target $146.10
...
def raw_string_to_dict(input_string):
    ...
    for trade in input_as_list:
        ...
        # target = trade_split[-1] (Same as above line)
...
all_trades_formatted = raw_string_to_dict(all_trades_raw)
pprint.pprint(all_trades_formatted)

create_trades_file(output_file, all_trades_formatted)
